...
<h2>Binding scrollTop (vertical) of scrollable elements to variables in Svelte</h2>
<div class="firstDiv"></div>
<div style="width:100%; margin:2em auto;">
<div class="box" bind:this={box} on:scroll={scrollPos} on:mousemove={scrollPos}>
    <div class="sect sect1"  ></div>
    <div class="sect sect2"  ></div>
    <div class="sect sect3" ></div>
    <div class="sect sect4" ></div>
...
<div style="height:100vh; background:#757"></div>
<style>
